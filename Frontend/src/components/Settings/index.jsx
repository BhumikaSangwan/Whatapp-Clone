...
import { getName, getAbout } from '../profileData.js';
import {useState} from 'react'

function Settings() {
  // const [profileName, setProfileName] = useState("Bhumika Sangwan"); 
  //   const [profileAbout, setProfileAbout] = useState("It goes on."); 
    ...
    <>
      ...
      <div className={styles.myProfile}>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.about}>{getAbout()}</div>
        </div>
      </div>
      ...
      <div className={`${styles.moreInfo} ${styles.logOut}`}>
        <div className={styles.icon}>
        <svg 
          viewBox="0 0 24 24" 
          height="24" 
