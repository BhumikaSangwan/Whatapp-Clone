    ...
    <span
            ...
            >
              <svg
                ...
                height="40"
                width="40"
                style={{ border: "2px solid gray", borderRadius: "50%", boxShadow: "5px 0px 0px  #eae6df inherit" }}
                preserveAspectRatio="xMidYMid meet"
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contactList}>
        <ShowContact dp={dp} name={"PQR"} time="Yesterday">
          The message is sent
        </ShowContact>
        <ShowContact dp={dp} name={"ABC"} time="yesterday">
          The message is sent...
        </ShowContact>
        <Contacts dp={dp}/>
...
function Contacts(props)
{
  ...
  const { dp } = props;
    ...
    <div>
      {contacts.map((_, i) => (
        <ShowContact key={i} dp={dp} name={"ABC"} time="yesterday">
          The message is sent...
        </ShowContact>
      ))}
    </div>)
